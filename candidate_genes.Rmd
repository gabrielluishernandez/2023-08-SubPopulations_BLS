...
bias_and_all$density <- get_density(bias_and_all$clr, 
                                    bias_and_all$ncd05, 
                                    h = c(17, 17), n = 500)
...
for(i in 1:nrow(bias_and_all)) {                     
  ...
  if(bias_and_all$density[i] <= 0.0008342423 ){
...
write.table(bias_and_all, 
            "../gitstuff/2023-08-02-Single_Population_BLS/results/2023-08-03-Pop3.txt", 
            quote = FALSE, col.names = TRUE, row.names = FALSE)

write.table(bias_and_all$gene, 
            "../gitstuff/2023-08-02-Single_Population_BLS/results/2023-08-03-Pop3_Genes.txt", 
            quote = FALSE, col.names = FALSE, row.names = FALSE)

candidates_pop3 <- subset(bias_and_all, candens == "1")
write.table(candidates_pop3$gene, 
            "../gitstuff/2023-08-02-Single_Population_BLS/results/2023-08-03-Pop3_Candidate_Genes.txt", 
            quote = FALSE, col.names = FALSE, row.names = FALSE)
