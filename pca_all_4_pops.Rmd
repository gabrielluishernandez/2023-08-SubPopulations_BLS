...
ggplot(ncd_plot_data %>% arrange(candens), 
  ...
  #geom_label_repel(data = strong_genes, aes(label = gene), colour = "black",
   #                size= 2, nudge_x = 3, nudge_y = 6, direction = "both",
    #               box.padding = 0.3, max.overlaps = 50) +
  scale_colour_viridis_d(option = "C", direction = -1, name = "Genes in top 1%",
                        labels = c("No","Yes")) + 
  labs(x = "CLR all samples", y = "CLR mean for 4 pops") + 
  #guides(shape = FALSE) +
  theme_minimal()
...
ggplot(dens_plot_data %>% arrange(candens), 
  ...
  #geom_label_repel(data = strong_genes, aes(label = gene), colour = "black",
   #                size= 2, nudge_x = 3, nudge_y = 6, direction = "both",
    #               box.padding = 0.3, max.overlaps = 50) +
  scale_colour_viridis_d(option = "A", direction = -1, name = "Genes in top 1%",
                        labels = c("No","Yes")) + 
  labs(x = "CLR all samples", y = "CLR mean for 4 pops") + 
  #guides(shape = FALSE) +
  theme_minimal()
...
quantile(means_for_density$density, 0.05)
